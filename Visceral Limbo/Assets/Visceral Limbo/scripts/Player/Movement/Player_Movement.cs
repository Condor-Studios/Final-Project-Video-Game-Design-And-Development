...
//  y los usara para realizar las diversas acciones del juego
    ...
    public class Player_Movement : Visceral_Script, ICharacterController
    {
        ...
        private Vector3 _RequestedAdditiveVelocity; // esta velocidad sera a�adida por encima de la velocidad actual del jugador
        ...
        ///
        /// todas las funciones a partir de ac� son parte del KCC utilizado para el movimiento
        ///
        ///
        ...
        public void UpdateRotation(ref Quaternion currentRotation, float deltaTime)
        {
            ...
            //pero no queremos rotarlo de arriba-abajo porque ser�a raro
        ...
        public void UpdateVelocity(ref Vector3 currentVelocity, float deltaTime)
        {
            ...
            if (_KCCMotor.GroundingStatus.IsStableOnGround)
            {
                ...
                else
                {
                    ...
                    //steering
                    {
                        ...
                        //a�adimos velocidad de steer, pero clampeamos la velocidad total para evitar sumar velocidad extra por steer
                ...
                //estamos en el aire
            {
                ...
                if (_RequestedMovement.sqrMagnitude> 0f)
                {
                    ...
                    {
                        //a�adir el valor de fuerza a la velocidad planar actual para tener un objetivo de movimiento
            ...
            if (_RequestedJump)
            {
                ...
                if (_KCCMotor.GroundingStatus.IsStableOnGround || CanCoyoteTime)
                {
                    ...
                    //a�adimos la diferencia entre velocidad actual y la deseada al KCC
        ...
        // a�adi : movimiento en el aire y agacharce
        // a�adi : aceleracion en la tierra y aire
        // a�adi : transicion de camara entre agacharse y levantarse
        // a�adi : comentarios y summaries a (casi) todas las funciones custom
        // acomode las variables para mas legibilidad
        // 
        //
        // patricio: 10/4/2025 - 21:30 - 01:47
        // a�adi : sliding, slide steering
        // a�adi : rework movimiento en el aire
        // a�adi : Coyote Timing
        // a�adi : Jump Queue
        // a�adi : StateReferences (saber el estado del jugador en el frame pasado)
